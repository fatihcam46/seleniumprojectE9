...
//  3- Verify “remember me” label text is as expected: Expected: Remember me on this computer:
        WebElement rememberMeLabel = driver.findElement(By.className("login-item-checkbox-label"));//right click>>inspect>>class="login-item-checkbox-label"
...
//4- Verify “forgot password” link text is as expected:Expected: Forgot your password?
        WebElement forgotPasswordLink = driver.findElement(By.className("login-link-forgot-pass"));
                                                            ////right click>>inspect>>class=login-link-forgot-pass
        ...
        String expectedInHref = "forgot_password=yes"; //https://login1.nextbasecrm.com/?forgot_password=yes
        String actualHrefAttributeValue = forgotPasswordLink.getAttribute("href");//right click>>inspect>>href
                                                              //getAttribute  we used
