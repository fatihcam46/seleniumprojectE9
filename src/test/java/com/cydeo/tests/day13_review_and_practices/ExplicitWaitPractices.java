...
//dynamicControlsPage >>pages look
...
//        wait.until(ExpectedConditions.invisibilityOf(dynamicControlsPage.loadingBar));
        ...
        BrowserUtils.waitForInvisibilityOf(dynamicControlsPage.loadingBar);//disappear loading bar
//utilities>>BrowserUtils
        ...
        try {
            ...
            Driver.getDriver().manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS);
          //  Assert.assertTrue(!dynamicControlsPage.checkbox.isDisplayed());//line 43 and 44 same
         //   Assert.assertFalse(dynamicControlsPage.checkbox.isDisplayed());  //you can do out of comment
