...
public class T1_xpath_cssSelector_practice {
    public static void main(String[] args) {
        ...
        //a. “Home” link
        //Locate homeLink using cssSelector, class value   //copy a[class='nav-link'
        WebElement homeLink_ex1= driver.findElement(By.cssSelector("a[class='nav-link']"));//right click>>inspect>>
        ...
        //c. “E-mail” text                                                 //tagName[@attribute='value']
        ...
        //tagName[contains(@attribute,'value')]          //input[contains(@pattern,'a-z'  some part of a-z
        WebElement inputBox_ex2 = driver.findElement(By.xpath("//input[contains(@pattern,'a-z')]"));

        //e. “Retrieve password” button
        //button[@type='submit']
        //button[@class='radius']    //*[@id="form_submit"]/i  right click>>copy xpath>>paste inside ""
        WebElement retrievePasswordBtn = driver.findElement(By.xpath("//button[@id='form_submit']"));

        //f. “Powered by Cydeo text
        WebElement poweredByCydeoText = driver.findElement(By.xpath("//div[@style='text-align: center;']"));

        //4. Verify all web elements are displayed.//isDisplayed() method//true or false
