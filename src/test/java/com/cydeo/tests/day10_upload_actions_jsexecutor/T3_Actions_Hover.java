...
//Hover: move the mouse on th top of somewhere ,something ,buttons display
...
//if I want to move, hover, action we need>>
        Actions actions = new Actions(Driver.getDriver());

        //2. Hover over to first image//
        BrowserUtils.sleep(2);//you dont need but if you want to see 2 seconds wait>>
        actions.moveToElement(img1).perform();

        //3. Assert:
        //a. “name: user1” is displayed
        Assert.assertTrue(user1.isDisplayed());//user1 gosterildi mi?
